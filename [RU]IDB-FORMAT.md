...
Есть два типа страниц, листовые страницы, которые не содержат указателей на другие
страниц, а только записи типа "ключ-значение". И индексные страницы с _preceeding_
указатель, и где все записи "ключ-значение" содержат указатель на страницу, где все
